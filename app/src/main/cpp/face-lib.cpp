...
#else
#define LOG_TAG "FaceRecognitionActivity/Native"
...
JNIEXPORT void JNICALL Java_com_sinergiass_asistencia_NativeMethods_TrainFaces(JNIEnv, jobject, jlong addrImages, jlong addrClasses) {
...
JNIEXPORT void JNICALL Java_com_sinergiass_asistencia_NativeMethods_MeasureDist(JNIEnv *env, jobject, jlong addrImage, jfloatArray minDist, jintArray minDistIndex, jfloatArray faceDist, jboolean useEigenfaces) {
    Facebase *pFacebase;
    if (useEigenfaces) {
