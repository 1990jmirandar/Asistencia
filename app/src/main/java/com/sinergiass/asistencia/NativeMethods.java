...
// All computations are done in an asynchronous task, so we do not skip any frames
class NativeMethods {
    private static final String TAG = MainActivity.class.getSimpleName() + "/" + NativeMethods.class.getSimpleName();
